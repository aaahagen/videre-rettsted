...
// The block is exactly this text. We just need to replace the FIRST occurrence with an empty string, because looking at the code from before, the first occurrence was mistakenly added to the "Opprett Ny Bruker" section when I did the initial migration of code, while the second one is correctly placed inside the "Organisasjonsinnstillinger" form.

const exactBlock = `              <div className="space-y-4 pt-6 border-t">
...
code = code.replace(exactBlock, '');

fs.writeFileSync(path, code);
console.log("Removed exact duplicate block safely");
...
import { Loader2, Route as RouteIcon, MapPin, User as UserIcon, GraduationCap, Truck, Package, Clock, CheckCircle2, BarChart3, ArrowRight, LogIn, Users2, HelpCircle, MessageSquare, Star, UserCheck } from 'lucide-react';
import { User, Route, WorkLog, Organization, CourseAssignment, Message, Order, Manifest } from '@/lib/types';
...
/**
 * DashboardPage er inngangsporten til applikasjonen for alle brukere.
 * 
 * Siden er delt inn i to hovedmoduser basert på brukerens rolle:
 * 1. **Admin/Eier-visning:** Et "Bento Box"-dashbord som aggregerer sanntidsdata
 *    på tvers av logistikk, flåte, ansatte og operasjonell fremdrift.
 * 2. **Sjåfør-visning:** En fokusert visning som prioriterer aktiv rute,
 *    timeregistrering (TimeStamp) og meldinger.
 */
      ...
      {isAdmin ? (
            ...
            <div className="w-full lg:w-2/3 space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="bg-indigo-50/30 rounded-xl border border-indigo-100/50 p-8 shadow-sm flex flex-col justify-between transition-all hover:shadow-md hover:bg-indigo-50/50">
                        <div>
                            ...
                            <div className="h-2 w-full bg-indigo-100/50 rounded-full overflow-hidden border border-indigo-200/20 mb-10">
                                <div className="h-full bg-indigo-500 transition-all duration-1000 ease-out" style={{ width: `${safeProgress(manifestProgress)}%` }} />
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm transition-all hover:shadow-md">
                        <div className="flex justify-between items-center mb-8 border-b border-slate-100 pb-4 shrink-0">
                            <div className="flex items-center gap-3">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col items-start p-4 bg-amber-50/20 border border-amber-100/50 rounded-xl group">
                                <span className="text-[10px] text-amber-600/60 font-black uppercase tracking-tighter mb-2 flex items-center gap-2"><Clock className="h-3 w-3"/> Venter</span>
                            ...
                            <div className="flex flex-col items-start p-4 bg-blue-50/20 border border-blue-100/50 rounded-xl group">
                                <span className="text-[10px] text-blue-600/60 font-black uppercase tracking-tighter mb-2 flex items-center gap-2"><BarChart3 className="h-3 w-3"/> Lastet</span>
                            ...
                            <div className="flex flex-col items-start p-4 bg-emerald-50/20 border border-emerald-100/50 rounded-xl group">
                                <span className="text-[10px] text-emerald-600/60 font-black uppercase tracking-tighter mb-2 flex items-center gap-2"><CheckCircle2 className="h-3 w-3"/> Levert</span>
                    ...
                    <div className="bg-blue-50/30 rounded-xl border border-blue-100/50 p-8 shadow-sm flex flex-col transition-all hover:shadow-md hover:bg-blue-50/50">
                        ...
                        <div className="space-y-4 flex-1">
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-blue-100 shadow-sm transition-transform hover:scale-[1.02] cursor-default">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="p-1.5 bg-blue-50 text-blue-500 rounded-md"><UserCheck className="h-4 w-4"/></div>På jobb</span>
                                <span className="text-lg font-black text-blue-600">{workforceStats.working}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-blue-100 shadow-sm transition-transform hover:scale-[1.02] cursor-default">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="p-1.5 bg-amber-50 text-amber-500 rounded-md"><Briefcase className="h-4 w-4"/></div>Innleid</span>
                                <span className="text-lg font-black text-amber-600">{workforceStats.contractors}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-blue-100 shadow-sm transition-transform hover:scale-[1.02] cursor-default">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="p-1.5 bg-red-50 text-red-500 rounded-md"><Activity className="h-4 w-4"/></div>Sykemelding</span>
                                <span className="text-lg font-black text-red-600">{workforceStats.sick}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-blue-100 shadow-sm transition-transform hover:scale-[1.02] cursor-default">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="p-1.5 bg-emerald-50 text-emerald-500 rounded-md"><Palmtree className="h-4 w-4"/></div>Ferie</span>
                                <span className="text-lg font-black text-emerald-600">{workforceStats.vacation}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-blue-100 shadow-sm transition-transform hover:scale-[1.02] cursor-default">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="p-1.5 bg-slate-50 text-slate-500 rounded-md"><Coffee className="h-4 w-4"/></div>Fri</span>
                                <span className="text-lg font-black text-slate-600">{workforceStats.off}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-blue-100 shadow-sm transition-transform hover:scale-[1.02] cursor-default">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="p-1.5 bg-slate-100 text-slate-500 rounded-md"><HelpCircle className="h-4 w-4"/></div>Annet</span>
                    ...
                    <div className="bg-slate-100/50 rounded-xl border border-slate-200/50 p-8 shadow-sm flex flex-col transition-all hover:shadow-md hover:bg-slate-100/80">
                        ...
                        <div className="space-y-4 flex-1">
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-slate-200 shadow-sm">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="w-3 h-3 rounded-full bg-emerald-500" /> Operative</span>
                                <span className="text-lg font-black text-slate-900">{fleetStats.ready}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-slate-200 shadow-sm">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="w-3 h-3 rounded-full bg-blue-500" /> På rute</span>
                                <span className="text-lg font-black text-slate-900">{fleetStats.on_tour}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-slate-200 shadow-sm">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="w-3 h-3 rounded-full bg-amber-500" /> Servicebehov</span>
                                <span className="text-lg font-black text-slate-900">{fleetStats.pending_workshop + fleetStats.observation}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-slate-200 shadow-sm">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="w-3 h-3 rounded-full bg-red-500" /> Verksted</span>
                                <span className="text-lg font-black text-slate-900">{fleetStats.workshop}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-slate-200 shadow-sm">
                                <span className="text-sm font-bold text-slate-600 flex items-center gap-4"><div className="w-3 h-3 rounded-full bg-slate-400" /> Parkert</span>
                ...
                <div className="bg-emerald-50/30 rounded-xl border border-emerald-100/50 p-8 shadow-sm transition-all hover:shadow-md hover:bg-emerald-50/50">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-5 bg-white border border-emerald-100 rounded-xl shadow-sm transition-transform hover:scale-[1.02]">
                            <div className="flex items-center gap-4"><div className="p-2 bg-emerald-100 text-emerald-600 rounded-lg"><LogIn className="h-5 w-5" /></div><span className="text-sm font-black text-slate-700">Til stede</span></div>
                        ...
                        <div className="flex items-center justify-between p-5 bg-white border border-blue-100 rounded-xl shadow-sm transition-transform hover:scale-[1.02]">
                            <div className="flex items-center gap-4"><div className="p-2 bg-blue-100 text-blue-600 rounded-lg"><CheckCircle2 className="h-5 w-5" /></div><span className="text-sm font-black text-slate-700">Ferdig</span></div>
                        ...
                        <div className="flex items-center justify-between p-5 bg-white border border-amber-100 rounded-xl shadow-sm transition-transform hover:scale-[1.02]">
                            <div className="flex items-center gap-4"><div className="p-2 bg-amber-100 text-amber-600 rounded-lg"><Clock className="h-5 w-5" /></div><span className="text-sm font-black text-slate-700">Venter</span></div>
        ...
        <div className="space-y-8 w-full max-w-[1200px] mx-auto">
            <div className="flex items-center gap-4">
                <div className="h-14 w-14 rounded-2xl bg-primary/10 flex items-center justify-center border border-primary/20"><UserIcon className="h-7 w-7 text-primary" /></div>
                <div>
                    <h1 className="text-3xl font-black tracking-tight text-slate-900">God dag, {userData.name.split(' ')[0]}!</h1>
                ...
                {isLogisticsEnabled && (
                    <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm flex flex-col h-full border-l-4 border-l-blue-600">
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3"><div className="p-2.5 bg-blue-50 text-blue-600 rounded-xl"><RouteIcon className="h-6 w-6" /></div><span className="text-xs font-black uppercase tracking-widest text-slate-400">Aktiv Rute</span></div>
                        ...
                        {activeRoute ? (
                            <div className="flex-1 space-y-6">
                                <div><p className="text-xl font-black text-slate-900 leading-tight">{activeRoute.name}</p><p className="text-xs text-slate-500 font-bold uppercase tracking-tight mt-1">{activeRoute.places.length} leveringer i dag</p></div>
                                {activeManifest && (
                                    <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 shadow-inner">
                                        <div className="flex justify-between items-center mb-3"><span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Lasting</span><span className="text-xs font-black text-slate-700 font-mono bg-white px-2 py-0.5 rounded border">{driverLoadedKolli} / {driverTotalKolli}</span></div>
                                        <div className="h-2.5 w-full bg-slate-200 rounded-full overflow-hidden mb-3"><div className="h-full bg-indigo-500 transition-all duration-700 ease-out" style={{ width: `${safeProgress(driverManifestProgress)}%` }} /></div>
                                        <div className="flex justify-center">
                                            {activeManifest.status === 'verified' ? (<span className="text-[10px] text-green-700 bg-green-100 px-3 py-1 rounded-full border border-green-200 font-black uppercase tracking-tighter flex items-center gap-1.5"><CheckCircle2 className="h-3.5 w-3.5"/> Verifisert & Klar</span>) : activeManifest.status === 'loading' ? (<span className="text-[10px] text-amber-700 bg-amber-100 px-3 py-1 rounded-full border border-amber-200 font-black uppercase tracking-tighter flex items-center gap-1.5"><Loader2 className="h-3.5 w-3.5 animate-spin"/> Laster...</span>) : (<span className="text-[10px] text-slate-600 bg-slate-200 px-3 py-1 rounded-full border border-slate-300 font-black uppercase tracking-tighter flex items-center gap-1.5"><Clock className="h-3.5 w-3.5"/> Venter på lasting</span>)}
                                        </div>
                                    </div>
                                )}
                                <Button asChild size="lg" className="w-full font-black uppercase tracking-widest h-12 shadow-lg shadow-primary/20"><Link href={`/dashboard/routes/${activeRoute.id}`}>Åpne Kontrollpanel</Link></Button>
                            </div>
                        ) : (
                            <div className="flex-1 flex flex-col items-center justify-center text-center py-8">
                                <div className="p-4 bg-slate-50 rounded-full mb-4"><RouteIcon className="h-8 w-8 text-slate-300" /></div>
                                <p className="text-slate-400 text-sm font-bold uppercase tracking-tight mb-6">Ingen planlagt rute</p>
                                <Button variant="outline" size="sm" asChild className="font-black uppercase tracking-tighter"><Link href="/dashboard/routes">Se alle ruter</Link></Button>
                            </div>
                        )}
                    </div>
                )}
                ...
                <div className="flex flex-col gap-6 h-full">
                    {isMessagesEnabled && (
                        <Link href="/dashboard/messages" className="group bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-blue-600 transition-all hover:shadow-md border-b-4 border-b-slate-200 hover:border-b-blue-600 flex-1 flex items-center justify-between">
                            <div className="flex items-center gap-4"><div className="p-3 bg-blue-50 text-blue-600 group-hover:scale-110 transition-transform rounded-xl"><MessageSquare className="h-6 w-6" /></div><div className="flex flex-col"><span className="font-black text-slate-800 uppercase tracking-tight text-sm">Meldinger</span><span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Kommunikasjon</span></div></div>
                            {unreadMessagesCount > 0 && (<div className="h-8 w-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-black text-xs animate-bounce shadow-lg shadow-blue-200">{unreadMessagesCount}</div>)}
                        </Link>
                    )}
                    ...
                    {isLearningEnabled && (
                        <Link href="/dashboard/learning" className="group bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-indigo-600 transition-all hover:shadow-md border-b-4 border-b-slate-200 hover:border-b-indigo-600 flex-1 flex items-center justify-between">
                            <div className="flex items-center gap-4"><div className="p-3 bg-indigo-50 text-indigo-600 group-hover:scale-110 transition-transform rounded-xl"><GraduationCap className="h-6 w-6" /></div><div className="flex flex-col"><span className="font-black text-slate-800 uppercase tracking-tight text-sm">Læringsportal</span><span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Kurs & Opplæring</span></div></div>
                            {pendingCoursesCount > 0 && (<div className="h-8 w-8 bg-indigo-600 rounded-full flex items-center justify-center text-white font-black text-xs shadow-lg shadow-indigo-200">{pendingCoursesCount}</div>)}
                        </Link>
                    )}
                </div>

                <div className="h-full">{userData.orgId && <NewestPlaceCard orgId={userData.orgId} />}</div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-4">
                <Link href="/dashboard/places" className="group bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:border-primary transition-all hover:shadow-md border-b-4 border-b-slate-200 hover:border-b-primary">
                    <div className="flex items-center gap-4"><div className="p-3 bg-slate-50 text-slate-400 group-hover:bg-primary/10 group-hover:text-primary rounded-xl transition-all group-hover:scale-110"><MapPin className="h-6 w-6" /></div><div className="flex flex-col"><span className="font-black text-slate-800 group-hover:text-primary transition-colors uppercase tracking-tight text-sm">Kart & Register</span><span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Alle lokasjoner</span></div></div>
                </Link>
                ...
                {isLogisticsEnabled && (
                    <Link href="/dashboard/routes" className="group bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:border-primary transition-all hover:shadow-md border-b-4 border-b-slate-200 hover:border-b-primary">
                        <div className="flex items-center gap-4"><div className="p-3 bg-slate-50 text-slate-400 group-hover:bg-primary/10 group-hover:text-primary rounded-xl transition-all group-hover:scale-110"><RouteIcon className="h-6 w-6" /></div><div className="flex flex-col"><span className="font-black text-slate-800 group-hover:text-primary transition-colors uppercase tracking-tight text-sm">Ruteoversikt</span><span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Planlagte turer</span></div></div>
                    </Link>
                )}
                ...
                <Link href="/dashboard/favorites" className="group bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:border-yellow-500 transition-all hover:shadow-md border-b-4 border-b-slate-200 hover:border-b-yellow-500">
                    <div className="flex items-center gap-4"><div className="p-3 bg-slate-50 text-slate-400 group-hover:bg-yellow-50 group-hover:text-yellow-600 rounded-xl transition-all group-hover:scale-110"><Star className="h-6 w-6" /></div><div className="flex flex-col"><span className="font-black text-slate-800 group-hover:text-yellow-600 transition-colors uppercase tracking-tight text-sm">Favoritter</span><span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Dine lagrede steder</span></div></div>
                </Link>
            </div>
        </div>
      )}

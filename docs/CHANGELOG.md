...
- **Firestore Offline Persistence Error:** Fixed an issue where the IndexedDB transaction failed on offline presence by configuring Firestore to use persistentSingleTabManager.

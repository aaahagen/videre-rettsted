...
### Added
- **Place Opening Hours (Phase A):** Implemented a comprehensive scheduling system for delivery locations. Administrators can now define daily opening and closing times for each place. This data is visualized in a dedicated grid on the place details page and will be used as a critical constraint for intelligent route planning and ETA validation.

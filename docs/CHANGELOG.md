...
### Added
- **Admin Attendance Statistics Card:** Added a new real-time tracking card to the Admin Dashboard. It displays high-level metrics for today's attendance, including personnel currently present, those who have finished their shifts, and those still waiting to clock in, cross-referenced with the daily schedule.

...
### Changed
- **Place Details Layout Update:** Relocated the "Åpningstider" (Opening Hours) section from the main content column to a collapsible card in the right sidebar, positioned directly under the Hashtags. This provides a cleaner view for drivers and planners.
